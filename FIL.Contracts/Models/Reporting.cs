...
namespace FIL.Contracts.Models
{
    public class Reporting
    {
        ...
        public IEnumerable<FIL.Contracts.DataModels.ReportingColumnsUserMapping> ReportingColumnsUserMapping { get; set; }
        public IEnumerable<FIL.Contracts.DataModels.ReportingColumnsMenuMapping> ReportingColumnsMenuMapping { get; set; }
    }
}