...
class MasterEventCreation extends React.Component<EventCreationProps, any>{
    inputElement: any;
    constructor(props) {
        super(props);
        this.state = {
    ...
    notify = () => {
        toast.success('Your general information has been saved successfully!', {
            position: "top-center",
            autoClose: 6000,
    ...
    private saveEventData = (values) => {
        ...
        this.props.saveEvent(values, (response: EventCreationResponseViewModel) => {
            if (response.success == true) {
                alert("Your general information has been saved successfully!");
                if (!this.state.isEdit) {
