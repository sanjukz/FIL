CREATE proc [dbo].[BO_ShowSeatsForBarcode] --'10701206,10701223'                                               
(                                                                                    
...
Isnull(WCS.IsWheelChair,0) AS IsWheelChair, 0 AS  IsFamilyPkg, 0 AS IsLayoutAvail, EA.TicketHtml AS TicketHtml,       
...
CreatedUtc,Id FROM Transactions WHERE Id = @EventTransID        
