...
{
    public interface IAccountEmailSender : IEmailSender
    {
    }

    public class AccountEmailSender : EmailSender, IAccountEmailSender
    {
        public AccountEmailSender(ILogger logger, ISettings settings)
