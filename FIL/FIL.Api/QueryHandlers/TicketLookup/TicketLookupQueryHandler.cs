...
{
    public class TicketLookupQueryHandler : IQueryHandler<TicketLookupQuery, TicketLookupQueryResult>
    {
        ...
        public TicketLookupQueryHandler(
        ...
        public TicketLookupQueryResult Handle(TicketLookupQuery query)
        {
            ...
            try
            {
                ...
                if (transaction == null)
                {
                    return new TicketLookupQueryResult();
                }
                ...
                var transactionPaymentDetail = _transactionPaymentDetailRepository.GetByTransactionId(query.TransactionId);
                var transactionPaymentDetailList = _transactionPaymentDetailRepository.GetPaymentDetailByTransactionId(query.TransactionId);
                    ...
                    var subEventContainer = tEventDetail.Select(ed =>
                    {
                     ...
                     .Where(etd => ed.Id == etd.EventDetailId);
                        ...
                        var matchSeatTicketDetailContainer = tEventTicketDetail.Select(etd =>
                             {
                                 var tMatchSeatTicketDetail = _matchSeatTicketDetailRepository.GetByTransactionIdAndTicketDetailId(transaction.Id, etd.Id);
                ...
                return new TicketLookupQueryResult
                {
                    Transaction = AutoMapper.Mapper.Map<FIL.Contracts.Models.Transaction>(transaction),
            ...
            catch (System.Exception ex)
            {
                ...
                return new TicketLookupQueryResult
                {
                    Transaction = null,
                    PaymentOption = null,
                    PayconfigNumber = null,
                    CurrencyType = null,
                    TicketLookupSubContainer = null
                };
            }
        }
    }
