...
{
    public class GetPartialVoidDetailQueryHandler : IQueryHandler<GetPartialVoidDetailQuery, ReprintRequestQueryResult>
    {
        ...
        public GetPartialVoidDetailQueryHandler(IMatchSeatTicketDetailRepository matchSeatTicketDetailRepository, IEventTicketDetailRepository eventTicketDetailRepository, ITicketCategoryRepository ticketCategoryRepository, IEventDetailRepository eventDetailRepository, IVenueRepository venueRepository, ICityRepository cityRepository, ITransactionRepository transactionRepository)
        {
        ...
        public ReprintRequestQueryResult Handle(GetPartialVoidDetailQuery query)
        {
            Nullable<long> transactionId = null;
            if (query.BarcodeNumber != "")
            {
                var matchSeatTicketDetails = _matchSeatTicketDetailRepository.GetByBarcodeNumber(query.BarcodeNumber);
                var transaction = _transactionRepository.Get(Convert.ToInt64(matchSeatTicketDetails.TransactionId));
            ...
            var matchSeatTicketDetail = _matchSeatTicketDetailRepository.GetbyTransactionId(Convert.ToInt64(transactionId));
