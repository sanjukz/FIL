...
{
    public class ScanningReportQueryHandler : IQueryHandler<ScanningReportQuery, ScanningReportQueryResult>
    {
        ...
        public ScanningReportQueryHandler(
        ...
        public ScanningReportQueryResult Handle(ScanningReportQuery query)
        {
            ...
            try
            {
                reporting = _reportingRepository.GetScanningReportData(query);
                ...
                return new ScanningReportQueryResult
                {
