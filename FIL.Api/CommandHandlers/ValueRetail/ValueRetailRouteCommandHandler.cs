...
{
    public class ValueRetailRouteCommandHandler : BaseCommandHandler<ValueRetailRouteCommand>
    {
        ...
        private readonly IValueRetailReturnStopRepository _valueRetailReturnStopsRepository;
        private readonly IValueRetailAPI _valueRetailAPI;

        public ValueRetailRouteCommandHandler(
            ILogger logger,
            ISettings settings,
            IMediator mediator,
            IValueRetailVillageRepository valueRetailVillageRepository,
            IValueRetailRouteRepository valueRetailRouteRepository,
            IValueRetailReturnStopRepository valueRetailReturnStopsRepository,
           ...
           : base(mediator)
        {
            ...
            _valueRetailReturnStopsRepository = valueRetailReturnStopsRepository;
