...
{
    public class TransactionReportQueryHandler : IQueryHandler<TransactionReportZsuiteQuery, TransactionReportQueryByDateResult>
    {
        ...
        public TransactionReportQueryByDateResult Handle(TransactionReportZsuiteQuery query)
        {
            ...
            try
            {
                reporting = _reportingRepository.GetTransactionReportData(query);
